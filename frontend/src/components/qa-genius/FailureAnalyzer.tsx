  ...
  return (
    <div className="mt-4 rounded-xl border border-red-500/30 bg-red-500/5 overflow-hidden animate-slide-up">
        ...
        <div className="flex items-center gap-2.5">
          ...
          <div>
            ...
            <p className="text-xs text-slate-400 mt-0.5">
              Click the button to fetch Coralogix logs (MCP) and get an AI root-cause analysis
            </p>
          </div>
        </div>
        <button
      ...
      <div className="px-5 py-3 bg-surface-900/50">
        <pre className="text-xs text-red-300 font-mono whitespace-pre-wrap line-clamp-4">
          {errorDetails}
        </pre>
      </div>
                      ...
                      {log.statusCode && (
                        <span
                          className={clsx(
                            ...
                            log.statusCode >= 500 ? "text-red-400" : "text-green-400"
                          )}
                        >
                          HTTP {log.statusCode}
                        </span>
