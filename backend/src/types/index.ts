 ...
 * schema change — see FINTECH_KEYWORDS/AUTH_KEYWORDS/GAMING_KEYWORDS in llm.ts.
 */
...
export interface GenerateManualStdRequest {
  prdText?: string;
  swaggerContent?: string;
  featureName: string;
  inputType: InputType;
...
export interface GenerateManualStdResponse {
